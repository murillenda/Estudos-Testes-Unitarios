...
public class ArmazenamentoEditorFixoEmMemoria implements ArmazenamentoEditor {
    ...
    // flags para confirmar que passou
    ...
    public Optional<Editor> encontrarPorEmail(String email) {
        if (email.equals("murillo.existe@email.com")) {
             return Optional.of(new Editor(2L, "Murillo", "murillo.existe@email.com", BigDecimal.TEN, true));
        }
        return Optional.empty();
    }
