...
class CadastroEditorTest {
    ...
    @BeforeEach
    void beforeEach() {
        editor = new Editor(null, "Murillo", "murillo@gmail.com", BigDecimal.TEN, true);
    ...
    @Test
    void Dado_um_editor_com_email_existente_Quando_criar_Entao_deve_lancar_execption() {
        editor.setEmail("murillo.existe@email.com");
